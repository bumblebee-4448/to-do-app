...
export const Button = forwardRef(function Button(
  { className, size = 'default', variant = 'primary', type = 'button', ...props }: ButtonProps,
  ...
  return (
    <button
      ...
      type={type}
      className={cn(
        'inline-flex items-center justify-center gap-2 rounded-md border text-sm font-medium transition duration-200 ease-editorial active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50',
        variants[variant],
        sizes[size],
        className,
      )}
